...
df_inc = (
    df_inc.select(
        ...
        F.col("id_endereco").cast("int").alias("id_endereco"),
        F.to_timestamp("data_pedido").alias("data_pedido"),
        F.col("status_pedido").cast("string").alias("status_pedido"),
        F.col("valor_total").cast(DecimalType(12, 2)).alias("valor_total"),
