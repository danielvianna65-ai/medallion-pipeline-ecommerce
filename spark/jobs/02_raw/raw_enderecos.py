...
df_inc = (
    df_inc .select(
        ...
        F.col("logradouro").cast("string").alias("logradouro"),
        F.col("numero").cast("string").alias("numero"),
        F.col("bairro").cast("string").alias("bairro"),
        F.col("cidade").cast("string").alias("cidade"),
        F.col("estado").cast("string").alias("estado"),
        F.col("cep").cast("string").alias("cep"),
