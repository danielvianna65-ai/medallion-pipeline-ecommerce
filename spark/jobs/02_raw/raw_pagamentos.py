...
df_inc = (
    df_inc.select(
        ...
        F.col("status_pagamento").cast("string").alias("status_pagamento"),
        F.to_timestamp("data_pagamento").alias("data_pagamento"),
        F.col("valor_pago").cast(DecimalType(12, 2)).alias("valor_pago"),
